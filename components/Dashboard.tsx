...
interface DashboardProps {
  ...
  onUpdateDocente: (docente: Docente) => void;
...
const Dashboard: React.FC<DashboardProps> = ({ graduates, docentes, turmas, onUpdate, onDelete, onUpdateDocente, onDeleteDocente, projetos, onUpdateProjeto, onDeleteProjeto }) => {
  ...
  const [activeTable, setActiveTable] = useState<'egressos' | 'projetos' | 'docentes'>('egressos');
  ...
  const getTabClassName = (tabName: 'egressos' | 'projetos' | 'docentes') => {
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="bg-white dark:bg-gray-800 p-5 rounded-lg shadow text-center transition-transform transform hover:scale-105">
            <h4 className="text-base font-medium text-gray-500 dark:text-gray-400">Total de Projetos</h4>
            <p className="mt-2 text-4xl font-bold text-orange-600 dark:text-orange-400">{totalProjetos}</p>
        </div>
        <div className="bg-white dark:bg-gray-800 p-5 rounded-lg shadow text-center transition-transform transform hover:scale-105">
            <h4 className="text-base font-medium text-gray-500 dark:text-gray-400">Mestrandos em Projetos</h4>
            <p className="mt-2 text-4xl font-bold text-yellow-500 dark:text-yellow-400">{totalMestrandosProjetos}</p>
        </div>
        <div className="bg-white dark:bg-gray-800 p-5 rounded-lg shadow text-center transition-transform transform hover:scale-105">
            <h4 className="text-base font-medium text-gray-500 dark:text-gray-400">Doutorandos em Projetos</h4>
            <p className="mt-2 text-4xl font-bold text-cyan-500 dark:text-cyan-400">{totalDoutorandosProjetos}</p>
        </div>
        <div className="bg-white dark:bg-gray-800 p-5 rounded-lg shadow text-center transition-transform transform hover:scale-105">
            <h4 className="text-base font-medium text-gray-500 dark:text-gray-400">Projetos NÃO Ins-Aca-Age-Fom</h4>
            ...
            <>
              <div className="border-b border-gray-200 dark:border-gray-700">
                <nav className="-mb-px flex space-x-8" aria-label="Tabs">
                  ...
                  <button
                    onClick={() => setActiveTable('docentes')}
                    className={getTabClassName('docentes')}
                  >
                    Lista de Docentes
                  </button>
                </nav>
              ...
              <div className="mt-4">
                ...
                {activeTable === 'docentes' && (
                   <DocenteTable data={filteredDocentes} onUpdate={onUpdateDocente} onDelete={onDeleteDocente} />
                )}
              </div>
            </>
           )}

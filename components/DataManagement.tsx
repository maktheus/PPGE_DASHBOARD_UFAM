...
import { Graduate, Course, Status, Docente, Projeto, Turma, AlunoRegular, Periodico, Conferencia } from '../types';
...
const DataManagement: React.FC<DataManagementProps> = ({ 
  ...
  const handleBackup = useCallback(() => {
    ...
    document.body.removeChild(a);
    URL.revokeObjectURL(url);
  }, [graduates, docentes, projetos, turmas, alunosRegulares, periodicos, conferencias]);
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between">
          <div>
            <h3 className="text-xl font-bold text-gray-800 dark:text-gray-200">6. Gerenciamento de Dados - Publicações</h3>
